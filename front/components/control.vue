<template>
  <div>
    ...
    <!-- <v-dialog v-model="addWindow" max-width="700">
      <v-card class="my-10 pa-5" max-width="700">
        <v-card-title class="d-flex justify-center pt-5"
          >Nuevo Certificado</v-card-title
        >
        <v-divider></v-divider>
        <v-card-text class="pa-3">
          <v-form onSubmit="return false;" @submit="">
            ...
            <v-row class="mt-8 mx-auto">
              <v-btn color="success" class="pa-2" @click="addOC()"
                >Agregar</v-btn
              >
            </v-row>
          </v-form>
    ...
    <!-- <v-dialog v-model="editWindow" max-width="700">
      <v-card class="my-10 pa-5" max-width="700">
        <v-card-title class="d-flex justify-center pt-5"
          >Editar Certificado</v-card-title
        >
        <v-divider></v-divider>
        <v-card-text class="pa-3">
          <v-form onSubmit="return false;" @submit="">
            ...
            <v-row class="mt-8 mx-auto">
              <v-btn color="success" class="pa-2" @click="editOC()"
                >Editar</v-btn
              >
            </v-row>
          </v-form>
